...
goToListBtn.addEventListener("click", ()=>{
    ...
    // pathname에서 뒤에 번호만 지우면 목록으로 갈 수 있는 주소가 될거래. 
    // 이 뒤에 쿼리스트링(?cp=?) 넣어주면 된데.

    const pathname = location.pathname; // /board/1/1500 이런식의 주소가 나올거래
