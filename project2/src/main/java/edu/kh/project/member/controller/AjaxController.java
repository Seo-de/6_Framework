...
public class AjaxController {
	...
	public int emailDupCheck(String memberEmail) {
								// data : {"memberEmail" : memberEmail.value} 담겨옴
...
//		System.out.println(memberEmail);
		...
		// result = 0이라면 return이 /WEB-INF/views/0.jsp로 forward되는 거래
...
//		String result = "{\"memberEmail\" : \"user01@kh.or.kr\", \"memberNickname\" : \"123\"}";
		//{"memberEmail" : "user01@kh.or.kr", "memberNickname" : "???"} 이렇게 뜨는데 ???는 문자 인코딩이 안되서 그렇데
		// JSON 형식이래 이게
//		return result;
